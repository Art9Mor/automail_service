...
class Mailing(models.Model):
    ...
    start_date = models.DateTimeField(default=timezone.now, verbose_name='Вреия начала рассылки')
    ...
    def __str__(self):
        return f'{self.name}(Кому: {self.mail_to}, Дата создания: {self.start_date}, Статус: {self.status})'
